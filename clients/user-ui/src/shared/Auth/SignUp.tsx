        ...
        <div>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className=' w-full mt-3'>
                    ...
                    <input {...register("phone_number")} type="number" placeholder='+94ß77652**' className={`${styles.input}`} />
                    {errors.email && (
                        <span className=' text-red-500 block mt-1 '>{`${errors.email.message}`}</span>
                    )}
                </div>
                ...
                <div className=' w-full mt-5'>
                    ...
                    <input type="submit" value="Sign Up" disabled={isSubmitting} className={`${styles.button} mt-3`} />
                </div>
                <br />
